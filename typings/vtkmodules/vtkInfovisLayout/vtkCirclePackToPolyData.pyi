...
class vtkCirclePackToPolyData(__vtkmodules_vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    """
    ...
    def NewInstance(self):
        """
        V.NewInstance() -> vtkCirclePackToPolyData
    ...
    def SafeDownCast(self, vtkObjectBase):
        """
        V.SafeDownCast(vtkObjectBase) -> vtkCirclePackToPolyData
        C++: static vtkCirclePackToPolyData *SafeDownCast(
            vtkObjectBase *o)
        """
        ...
    
    def SetCirclesArrayName(self, string):
        """
        V.SetCirclesArrayName(string)
