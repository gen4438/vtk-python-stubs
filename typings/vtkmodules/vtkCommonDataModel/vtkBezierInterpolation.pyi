...
class vtkBezierInterpolation(vtkHigherOrderInterpolation):
    ...
    See Also:
    """
    def deCasteljauSimplex(self, p_int, p_int_1, float_tuple, *float):
        """
        V.deCasteljauSimplex(int, int, (float, ...), [float, ...])
        C++: static void deCasteljauSimplex(const int dim, const int deg,
            const double *pcoords, double *weights)
        """
        ...
    
    def deCasteljauSimplexDeriv(self, p_int, p_int_1, float_tuple, *float):
        """
        V.deCasteljauSimplexDeriv(int, int, (float, ...), [float, ...])
    ...
    def flattenSimplex(self, p_int, p_int_1, vtkVector3i):
        """
        V.flattenSimplex(int, int, vtkVector3i) -> int
    ...
    def NewInstance(self):
        """
        V.NewInstance() -> vtkBezierInterpolation
    ...
    def SafeDownCast(self, vtkObjectBase):
        """
        V.SafeDownCast(vtkObjectBase) -> vtkBezierInterpolation
    ...
    def unflattenSimplex(self, p_int, p_int_1, p_int_2):
        """
        V.unflattenSimplex(int, int, int) -> vtkVector3i
