...
class vtkHyperTreeGridNonOrientedGeometryCursor(__vtkmodules_vtkCommonCore.vtkObject):
    """
    ...
    def Clone(self):
        """
        V.Clone() -> vtkHyperTreeGridNonOrientedGeometryCursor
    ...
    def GetHyperTreeGridOrientedGeometryCursor(self, vtkHyperTreeGrid):
        """
        V.GetHyperTreeGridOrientedGeometryCursor(vtkHyperTreeGrid)
    ...
    def Initialize(self, vtkHyperTreeGrid, p_int, bool):
        ...
        C++: void Initialize(vtkHyperTreeGrid *grid, vtkIdType treeIndex,
            bool create=false)
        V.Initialize(vtkHyperTreeGrid, vtkHyperTree, int, int, [float,
            ...])
        C++: void Initialize(vtkHyperTreeGrid *grid, vtkHyperTree *tree,
            unsigned int level, vtkIdType index, double *origin)
        V.Initialize(vtkHyperTreeGridNonOrientedGeometryCursor)
        C++: void Initialize(
    ...
    def NewInstance(self):
        """
        V.NewInstance() -> vtkHyperTreeGridNonOrientedGeometryCursor
