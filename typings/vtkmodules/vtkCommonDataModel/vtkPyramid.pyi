...
class vtkPyramid(vtkCell3D):
    ...
    def GetPointToIncidentEdgesArray(self, p_int):
        """
        V.GetPointToIncidentEdgesArray(int) -> (int, int, int, int)
    ...
    def GetPointToIncidentFacesArray(self, p_int):
        """
        V.GetPointToIncidentFacesArray(int) -> (int, int, int, int)
    ...
    def GetPointToOneRingPointsArray(self, p_int):
        """
        V.GetPointToOneRingPointsArray(int) -> (int, int, int, int)
    ...
    def InterpolateDerivs(self, , p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=...):
        """
    ...
    def InterpolateFunctions(self, , p_float=..., p_float=..., p_float=..., p_float=..., p_float=...):
        """
    ...
    def InterpolationDerivs(self, , p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=..., p_float=...):
        """
    ...
    def InterpolationFunctions(self, , p_float=..., p_float=..., p_float=..., p_float=..., p_float=...):
        """
