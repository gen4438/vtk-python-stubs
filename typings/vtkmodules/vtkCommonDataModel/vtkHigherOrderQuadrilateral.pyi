...
class vtkHigherOrderQuadrilateral(vtkNonLinearCell):
    ...
    def NewInstance(self):
        """
        V.NewInstance() -> vtkHigherOrderQuadrilateral
    ...
    def SafeDownCast(self, vtkObjectBase):
        """
        V.SafeDownCast(vtkObjectBase) -> vtkHigherOrderQuadrilateral
        C++: static vtkHigherOrderQuadrilateral *SafeDownCast(
            vtkObjectBase *o)
        """
        ...
    
    def SetOrder(self, p_int, p_int_1):
        """
        V.SetOrder(int, int)
        C++: virtual void SetOrder(const int s, const int t)
        """
        ...
