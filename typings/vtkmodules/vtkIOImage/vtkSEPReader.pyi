...
class vtkSEPReader(vtkImageReader):
    """
    ...
    all the information to interpret the raw data in the  .H@ file. The
    only supported data_format are xdr_float and native_float, with a
    esize of 4.
    """
    ...
    def SafeDownCast(self, vtkObjectBase):
        """
        V.SafeDownCast(vtkObjectBase) -> vtkSEPReader
